    ...
    success: function (data) {
        ...
        for (var i = 0; i < len; i++) {
            ...
            if(dayChange.indexOf('-') > -1){
                items.push("<tr><td>" + [i+1] + "</td><td> <a href='#' onclick='showGraph(this);' data-short='"+data[i].short+"'><span class='sprite sprite-" + lowerCaseName + " small_coin_logo'></span>" + data[i].long + " - " + data[i].short + "</a></td><td><a class='red' href='#' onclick='showGraph(this);' style='text-decoration: none;'> $" + numFormat + "</a></td><td><a href='#' onclick='showGraph(this);' style='color:#777;text-decoration: none;'> $" + numFormat1 + "</a></td><td><a href='#' onclick='showGraph(this);' style='color:#777;text-decoration: none;'>" + numFormat2 + "</a></td><td><a class='red' href='#' onclick='showGraph(this);' style='text-decoration: none;'>" + data[i].cap24hrChange + "% </a></td></tr>");
            } else {
                items.push("<tr><td>" + [i+1] + "</td><td> <a href='#' onclick='showGraph(this);' data-short='"+data[i].short+"'><span class='sprite sprite-" + lowerCaseName + " small_coin_logo'></span>" + data[i].long + " - " + data[i].short + "</a></td><td><a class='green' href='#' onclick='showGraph(this); ' style='text-decoration: none;'> $" + numFormat + "</a></td><td><a href='#' onclick='showGraph(this);' style='color:#777;text-decoration: none;'> $" + numFormat1 + "</a></td><td><a href='#' onclick='showGraph(this);' style='color:#777;text-decoration: none;'>" + numFormat2 + "</a></td><td><a class='green' href='#' onclick='showGraph(this);' style='text-decoration: none;'>" + data[i].cap24hrChange + "% </a></td></tr>");
            }
        }
        $("<tbody/>", {
            "class": "mainTable",
